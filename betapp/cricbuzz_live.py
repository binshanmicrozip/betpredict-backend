...
#     # Cricbuzz sometimes omits teamName from batTeam; fall back to
#     # commentaryList[0].batTeamName (short name always present).
#     # ---------------------------------------------------------
#     batting_team = bat_team.get("teamName", "") or ""

#     if not batting_team and commentary_list:
#         batting_team = (commentary_list[0] or {}).get("batTeamName", "") or ""

#     # Patch team1/team2 when both are missing but batting team is known
#     if batting_team and not team1_name and not team2_name:
#         team1_name = batting_team
#         # bowling team is the toss winner when they chose to bowl
#         if toss_decision.lower() == "bowling" and toss_winner_name:
#             team2_name = toss_winner_name
#         elif toss_decision.lower() == "batting" and toss_winner_name:
#             # toss winner bats, so batting_team == toss_winner_name
#             team1_name = toss_winner_name
#             team2_name = batting_team  # other team
...
#         elif toss_decision.lower() == "bowling" and toss_winner_name:
#             bowling_team = toss_winner_name

#     # Re-resolve batting_first/bowling_first with updated team names
#     if not batting_first_team and not bowling_first_team:
#         batting_first_team, bowling_first_team = _resolve_first_innings_teams(
#             toss_winner_name=toss_winner_name,
#             toss_decision=toss_decision,
#             team1=team1_name,
...
#     # For innings 1 we can infer batting_first from live batting_team
#     if not batting_first_team and batting_team and _safe_int(innings, 1) == 1:
#         batting_first_team = batting_team
#         if not bowling_first_team and toss_winner_name and toss_decision.lower() == "bowling":
#             bowling_first_team = toss_winner_name
